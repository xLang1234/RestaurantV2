  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-food-add-food-module"], {
    ...
    function srcAppAddFoodAddFoodPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddFoodPage = /*#__PURE__*/function () {
        function AddFoodPage(foodMenuService, camera) {
        ...
        _createClass(AddFoodPage, [{
          ...
          value: function ngOnInit() {
            console.log(this.foodMenuService.getAllFoodItems().subscribe(function (doc) {
              console.log(doc);
            }));
          }
        }, {
          ...
          value: function getImage() {
            ...
            this.camera.getPicture(cameraOptions).then(function (file_uri) {
              return _this.imageSrc = file_uri;
            }, function (err) {
    ...
    function srcAppServicesFoodmenuServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FoodmenuService = /*#__PURE__*/function () {
        function FoodmenuService(firestore) {
        ...
        _createClass(FoodmenuService, [{
          ...
          value: function addFoodItem(foodItem) {
            return this.firestore.collection(this.collectionName).add(foodItem).then(function (doc) {});
          }
        }, {
          key: "getAllFoodItems",
          value: function getAllFoodItems() {
            ...
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
              console.log(_this2.firestore.collection(_this2.collectionName));

              _this2.firestore.collection("/" + _this2.collectionName).get().subscribe(function (data) {
                var allData = [];
          ...
          value: function updateFoodItem(foodItem) {
            var ref = this.firestore.collection(this.collectionName).doc(foodItem.id);
            ref.update(foodItem);
          }
        }]);
