...
exports.columnar = exports.generateFillSpaceStringList = exports.expandPath = exports.prettyPath = void 0;
 ...
 */
function columnar(rows, { hsep = chalk.dim('-'), vsep = chalk.dim('|'), headers }) {
