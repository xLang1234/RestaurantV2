...
let FoodmenuService = class FoodmenuService {
    ...
    getAllFoodItems() {
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](observer => {
            firebase_app__WEBPACK_IMPORTED_MODULE_4___default.a.firestore().collection(this.collectionName).get().then(x => {
                let allData = [];
                x.forEach(y => {
                    console.log(y.data());
                    allData.push(y.data());
    ...
    getFoodById(id) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](observer => {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_4___default.a.firestore().collection(this.collectionName).where('id', '==', id).onSnapshot(x => {
                let allData = [];
                x.docs.forEach(y => {
                    allData.push(y.data());
                });
    ...
    deleteFoodById(id) {
        return firebase_app__WEBPACK_IMPORTED_MODULE_4___default.a.firestore().collection(this.collectionName).where('id', '==', id).onSnapshot(x => {
            let allData = [];
            x.docs.forEach(y => {
                y.ref.delete();
            });
    ...
    updateFoodItem(foodItem) {
        return firebase_app__WEBPACK_IMPORTED_MODULE_4___default.a.firestore().collection(this.collectionName).where('id', '==', foodItem.id).onSnapshot(x => {
            let allData = [];
            x.docs.forEach(y => {
                console.log(y);
